		...
		<div class="basicinfo_table">
			...
			<table  cellspacing="0" cellpadding="0">	
				...
				<tr><td class="basicinfo_title td_crossline">生日：</td>
					<td class="td_crossline">
						<input type="text" id="u_birth" class="birth" name="u_birth"  onclick="WdatePicker({minDate: '1900-01-01',startDate:'1980-01-01' })">
					</td>
				</tr>
			...
			<button id="btn_add" class="btn_save">添加用户</button>
