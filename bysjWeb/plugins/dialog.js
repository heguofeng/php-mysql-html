/*! art-dialog@7.0.0 | https://github.com/aui/artDialog */ ! function(t, e) {
				...
				if(this.__activeElement = this.__getActive(), this.open = !0, this.follow = t || this.follow, !this.__ready) {
					if(e.addClass(this.className).attr("role", this.modal ? "alertdialog" : "dialog").css("position", this.fixed ? "fixed" : "absolute"), a || i(window).on("resize", i.proxy(this.reset, this)), this.modal) {
						...
						e.addClass(this.className + "-modal"), u || i.extend(n, {
							...
							tabindex: "0"
						}).on("focus", i.proxy(this.focus, this)), this.__mask = o.clone(!0).attr("style", "").insertAfter(e), o.addClass(this.className + "-backdrop").insertBefore(e), this.__ready = !0
					}
			...
			button: function(t) {
				...
				return this.callbacks = {}, "string" == typeof t ? (o = t, i++) : r.each(t, function(t, n) {
					var a = n.id = n.id || n.value,
						u = "";
					e.callbacks[a] = n.callback, n.display === !1 ? u = ' style="display:none"' : i++, o += '<button type="button" i-id="' + a + '"' + u + (n.disabled ? " disabled" : "") + (n.autofocus ? ' autofocus class="ui-dialog-autofocus"' : "") + ">" + n.value + "</button>", e._$("button").on("click", "[i-id=" + a + "]", function(t) {
